...
void loop() {
    ...
    if (currentMillis - previousHygieneMillis >= hygieneInterval) {
        ...
        niveauHygiene = max(niveauHygiene - 2, 0); // Diminuer de 5%, mais pas en dessous de 0%
    ...
    // Ajoutez d'autres conditions pour d'autres menus si nécessaire

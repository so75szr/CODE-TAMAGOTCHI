...
void afficherMenuJeux() {
    ...
    if (afficherTexte) {
        ...
        if (selectionMenuJeux == 2) display.println("Dinos");
    }
...
void afficherMenuDouche() {
    ...
    if (afficherTexte) {
        ...
        if (selectionMenuDouche == 0) display.println("Brush");
        display.setCursor(46, 2);
        if (selectionMenuDouche == 1) display.println("Toilet");
        display.setCursor(52, 2);
        if (selectionMenuDouche == 2) display.println("Needs");
    }
...
void afficherNiveauFaim() {
    ...
    display.drawBitmap(92, 56, ChickenIcons, 10, 10, WHITE);
    display.print("%");
}
...
void afficherNiveauVie() {
    ...
    display.print(niveauVie);
    display.drawBitmap(52, 55, HeartIcons, 10, 10, WHITE);
    display.print("%");
}
...
void loop() {
    ...
    if (digitalRead(PIN_BOUTON_MILIEU) == LOW && !menuAffiche && !salleDeJeuxAffiche && !SalleDeDoucheAffiche && !SalleDeCuisineAffiche && !menuMangerAffiche && !quizEnCours) {
        delay(250);
        menuAffiche = true;
        afficherMenuPrincipal();
    }

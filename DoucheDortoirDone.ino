...
void afficherNiveauSommeil() {
    ...
    display.setCursor(22, 56); // Position en haut à droite de l'écran
    display.print(niveauSommeil);
    display.drawBitmap(12, 54, MoonIcons, 10, 10, WHITE);
    display.print("%");
}
...
void loop() {
    ...
    if (digitalRead(PIN_BOUTON_MILIEU) == LOW && !menuBoissonAffiche && !menuAffiche && !salleDeJeuxAffiche && !SalleDeDoucheAffiche && !SalleDeCuisineAffiche && !menuMangerAffiche && !quizEnCours) {
        delay(250);
        menuAffiche = true;
        afficherMenuPrincipal();
    }

...
const long faimInterval = 120000; // 2 minutes en millisecondes
...
const char* aliment[] = {"Pomme", "Steak"}; // Ajoutez plus d'aliments ici si nécessaire
...
void manger() {
    ...
    // Ajoutez ici les autres aliments avec leurs effets respectifs
